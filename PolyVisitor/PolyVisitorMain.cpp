// File: PolyVisitor/PolyVisitMain.cpp
...
int main(void) {
    Polynomial poly0;                            //zero polynomial poly0 = 0
    Polynomial poly1(Rational(7,9));           //constant polynomial poly1 = 7/9
    Polynomial poly2(Rational(-3,5), 2);       //monomial poly2 = -3/5 x^2
    Polynomial poly3(Rational(5,6), 8, poly2); //poly3 = 5/6 x^8 + -3/5 x^2
